...
![Basic example dashboard](https://raw.githubusercontent.com/atomazing/vite-config/master/examples/assets/basic-dashboard.png)

`examples/microfrontends/host` - Host runtime dashboard with remote loading states, endpoint info, and integration diagnostics.

![Microfrontends host dashboard](https://raw.githubusercontent.com/atomazing/vite-config/master/examples/assets/mf-host-dashboard.png)

`examples/microfrontends/remote` - Remote module dashboard showing exposed entry details and mount diagnostics.

![Microfrontends remote dashboard](https://raw.githubusercontent.com/atomazing/vite-config/master/examples/assets/mf-remote-dashboard.png)
